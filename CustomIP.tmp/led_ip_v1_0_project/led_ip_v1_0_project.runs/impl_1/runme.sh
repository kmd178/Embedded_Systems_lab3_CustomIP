...
HD_PWD='c:/users/kmd17/documents/github/embedded_systems_lab3_customip/customip.tmp/led_ip_v1_0_project/led_ip_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_ip_v1_0.tcl -notrace
